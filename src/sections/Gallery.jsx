...
const ITEMS = [
  {
    ...
    desc: "受付まわりの明度と導線。第一印象のブレを抑える。",
    img: "/auria-gallery-01.png",
    alt: "クリニックの受付空間。",
  },
  {
    slot: "slotB",
    title: "Head Spa Room",
    desc: "手元の光と素材。落ち着きが残る仕上げへ。",
    img: "/auria-gallery-02.png",
    alt: "ヘッドスパの個室。",
  },
  {
    slot: "slotC",
    title: "Villa Lounge",
    desc: "面の配分。広さが間延びしないように整える。",
    img: "/auria-gallery-03.png",
    alt: "ヴィラのラウンジ空間。",
  },
  {
    slot: "slotD",
    title: "Corridor",
    desc: "線と陰影。通路を“ただの移動”にしない。",
    img: "/auria-gallery-04.png",
    alt: "通路の内装。",
  },
  {
    slot: "slotE",
    title: "Materials & Light",
    desc: "明度 → 素材 → 光。基準を揃えて迷いを減らす。",
    img: "/auria-gallery-05.png",
    alt: "素材サンプルと光の検討。",
  },
  {
    slot: "slotF",
    title: "Sign & Lighting",
    desc: "見え方の統一。点の調整で全体の品が上がる。",
    img: "/auria-gallery-06.png",
    alt: "サインと照明の検討。",
  },
];
...
export default function Gallery() {
  ...
  return (
    <section ref={rootRef} id="gallery" className={cls} aria-labelledby="gallery-title">

...
export default function Promise() {
  ...
  return (
    <RevealSection id="promise" className={styles.section} aria-labelledby="promise-title">
      <div className={styles.wrap}>
        <div className={styles.inner}>
          ...
          <span
            className={`${styles.rule} ${styles.stagger}`}
            style={{ "--i": i++ }}
            aria-hidden="true"
          />
          ...
          <div className={styles.noGrid} role="list">
            {COPY.noItems.map((t) => (
              <p
                key={t}
                role="listitem"
                className={`${styles.noItem} ${styles.stagger}`}
                style={{ "--i": i++ }}
              >
                {t}
              </p>
